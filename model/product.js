...
module.exports = {
  ...
  async GetWetapProducts(req, res) {
    ...
    //   const brugere = 'medarbejder';
      ...
      pf.beskrivelse as 'filter',  fs.beskrivelse as 'frostsikker',  ls.beskrivelse as 'lægkagesystem',  plc.beskrivelse as 'plc-system',
      km.beskrivelse as 'kabinetmateriale',  vk.beskrivelse as 'vandtrykskrav', sf.beskrivelse as 'strømforsyning',
      dm.beskrivelse as 'dimensioner',  lys.beskrivelse as 'lys', kk.beskrivelse as 'kølekapacitet', vt.beskrivelse as 'vandtype' FROM produkt as p
